            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
                    ...
                    <div className="relative h-[600px] flex items-center justify-center">
                        ...
                        <div className="absolute -bottom-10 -right-4 md:right-10 w-[180px] h-[180px] md:w-[240px] md:h-[240px] rounded-full overflow-hidden border-8 border-[#FBF6F1] z-20 transition-transform duration-500 hover:scale-110">
                            <Image
                    ...
                    <div className="space-y-10 lg:pl-12">
                        ...
                        {/* Location Details */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-[#212842]/10">
                            <div>
