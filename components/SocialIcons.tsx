...
export default function SocialIcons() {
    const socialLinks = [
        {
            name: "Instagram",
            url: "https://instagram.com/drmayareynolds",
            icon: (
        ...
        {
            name: "Facebook",
            url: "https://facebook.com/drmayareynolds",
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        {
            name: "LinkedIn",
            url: "https://linkedin.com/in/drmayareynolds",
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        {
            name: "Twitter",
            url: "https://twitter.com/drmayareynolds",
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        {
            name: "YouTube",
            url: "https://youtube.com/@drmayareynolds",
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
