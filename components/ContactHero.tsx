            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div className="flex flex-col justify-center space-y-12">
                    ...
                    <div className="relative h-[350px] md:h-[450px] lg:h-[550px] w-full flex justify-center md:justify-start">
                        ...
                        <div className="absolute bottom-4 left-1/2 md:left-auto md:ml-40 -translate-x-1/2 md:translate-x-0 w-[120px] h-[120px] md:w-[180px] md:h-[180px] lg:w-[220px] lg:h-[220px] rounded-full overflow-hidden border-8 border-accent shadow-2xl z-20">
                            <Image
